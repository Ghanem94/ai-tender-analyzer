        ...
        <div className="space-y-8 p-4">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300 border-border/50 bg-card/50 backdrop-blur-sm">
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-foreground ltr">{totalUsersCount.toLocaleString()}</div>
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300 border-border/50 bg-card/50 backdrop-blur-sm">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">اجمالي الملفات المتاحة</CardTitle>
                        <div className="p-2 bg-amber-500/10 rounded-full text-amber-500">
                            <Coins className="h-4 w-4" />
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-foreground ltr">{availableUserCredits.toLocaleString()} نقطة</div>
                        <p className="text-xs font-medium text-amber-500 flex items-center mt-1">
                            رصيد نقاط غير مستهلك
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300 border-border/50 bg-card/50 backdrop-blur-sm">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">اجمالي الملفات المحللة</CardTitle>
                        <div className="p-2 bg-purple-500/10 rounded-full text-purple-500">
                            <Activity className="h-4 w-4" />
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-foreground ltr">{totalAnalyzedFiles.toLocaleString()} ملف</div>
