...
export default function ResultsPage() {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen bg-[#FDFCF9] font-sans selection:bg-[#9A8D59]/30 selection:text-[#1A1A1A]" dir="rtl">
            {/* SIDEBAR - Fixed height to avoid entire page scroll if not needed, flex layout ensures fit */}
            ...
            <main className="flex-1 overflow-y-auto h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-white via-[#FDFCF9] to-[#F4F2ED] p-6 lg:py-10 lg:px-10 relative custom-scrollbar">
                {/* Decorative Elements */}
                ...
                <div className="w-full space-y-8 relative z-10 pb-20">
                    ...
                    {hasWebhookResult ? (
                        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                            {/* Organized Tabs */}
                            <Tabs defaultValue="recommendation" className="w-full" dir="rtl">
                                <TabsList className="flex flex-wrap h-auto w-full justify-start items-center gap-2 bg-transparent p-0 mb-8 border-b border-[#E6E4DF]/50 pb-px">
                                    <TabsTrigger
                                        ...
                                        className="h-12 px-6 rounded-t-xl rounded-b-none border-b-2 border-transparent data-[state=active]:bg-[#9A8D59]/10 data-[state=active]:border-[#9A8D59] data-[state=active]:text-[#9A8D59] text-[#7D7D7D] font-bold text-base transition-all"
                                    >
                                ...
                                <div className="bg-white rounded-[2rem] p-8 md:p-10 shadow-xl shadow-black/[0.03] border border-white">
                                    ...
                                    <TabsContent value="recommendation" className="mt-0 outline-none">
                                        {recommendation ? (
                                            <div className="relative overflow-hidden group bg-gradient-to-br from-[#9A8D59]/10 via-[#FDFCF9] to-[#9A8D59]/5 rounded-[1.5rem] p-10 md:p-14 border border-[#9A8D59]/20 shadow-inner">
                                                ...
                                                <div className="relative z-10 flex flex-col items-center text-center gap-6 max-w-4xl mx-auto">
                                                    <div className="w-20 h-20 bg-white rounded-2xl shadow-lg border border-[#9A8D59]/20 flex items-center justify-center mb-4">
                                                        <Briefcase className="w-10 h-10 text-[#9A8D59]" />
                                                    </div>
                                                    <h4 className="text-3xl md:text-5xl font-extrabold text-[#1A1A1A] leading-tight tracking-tight">
                                                        {typeof recommendation === "string" ? recommendation : recommendation.title}
                                                    </h4>
                                                    {typeof recommendation !== "string" && recommendation.description && (
                                                        <p className="text-xl text-[#4A4A4A] leading-relaxed mt-4 font-medium">
